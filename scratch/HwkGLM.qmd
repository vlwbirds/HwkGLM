...
# percentages of alarm by social structure
percent_solo <- mean(hwk_fake$Alarm[hwk_fake$Social_Index == 0], na.rm = TRUE) * 100
percent_pair <- mean(hwk_fake$Alarm[hwk_fake$Social_Index == 1], na.rm = TRUE) * 100
percent_comp <- mean(hwk_fake$Alarm[hwk_fake$Social_Index == 2], na.rm = TRUE) * 100
percent_ssf <- mean(hwk_fake$Alarm[hwk_fake$Social_Index == 3], na.rm = TRUE) * 100
percent_msf <- mean(hwk_fake$Alarm[hwk_fake$Social_Index == 4], na.rm = TRUE) * 100

# Sample sizes
sample_solo <- sum(hwk_fake$Social_Index == 0, na.rm = TRUE)
sample_pair <- sum(hwk_fake$Social_Index == 1, na.rm = TRUE)
sample_comp <- sum(hwk_fake$Social_Index == 2, na.rm = TRUE)
sample_ssf <- sum(hwk_fake$Social_Index == 3, na.rm = TRUE)
sample_msf <- sum(hwk_fake$Social_Index == 4, na.rm = TRUE)
